...
write_nb("06_ホビー_陶芸3D/01_FreeCADで器をつくる.ipynb", cells)
...
write_nb("06_ホビー_陶芸3D/02_Blenderで器をつくる.ipynb", cells)
...
write_nb("06_ホビー_陶芸3D/03_SolidPythonで器をつくる.ipynb", cells)
