...
学習者に配る手引きは [`学習者ガイド.md`](学習者ガイド.md)（コード設定・進め方の1枚）。

各ノート末尾に「完了ログ」セルがあり、講座では学習の進捗（学習者コード・ノート名・日時）を Google スプレッドシートに記録できる。設定は [`docs/完了ログ_セットアップ.md`](docs/完了ログ_セットアップ.md)。
